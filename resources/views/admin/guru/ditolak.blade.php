@if($guruDitolak->isEmpty())
    <div class="bg-blue-50 border-l-4 border-blue-400 p-4">
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-blue-700">Belum ada guru yang ditolak</p>
            </div>
        </div>
    </div>
@else
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500">{{ $guru->alasan_penolakan }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        ...
                        <form action="{{ route('admin.guru.destroy', $guru) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data guru ini?')">
                            @csrf
                            @method('DELETE')
